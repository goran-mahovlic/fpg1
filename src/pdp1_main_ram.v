...
module pdp1_main_ram (
    ...
    // minskytron.hex contains the Minskytron program (start addr: 0o500)
    //
    // NOTE: Yosys IGNORES $readmemh for ECP5 BRAM!
    // We use explicit assignments generated by tools/hex2verilog_init.py
    // To regenerate: python3 tools/hex2verilog_init.py src/rom/minskytron.hex src/rom/minskytron_init.vh
    `include "rom/minskytron_init.vh"
