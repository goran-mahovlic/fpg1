...
module pdp1_main_ram (
    ...
    //
    // NOTE: Yosys IGNORES $readmemh for ECP5 BRAM!  << old way 
    // We use explicit assignments generated by tools/hex2verilog_init.py  << old way
    // To regenerate: python3 tools/hex2verilog_init.py  << old way
